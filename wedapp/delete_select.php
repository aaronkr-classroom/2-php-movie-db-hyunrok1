...
<html>
	<head><!--페이지정보 -->
		...
		<title>Movie wed app | Delete Search</title>
    </head>
	<body><!-- 페이지 내용 -->
		<!-- 시작 메뉴 화면 -->
		 <main data-role = "dialog" id = "page0">
		    ...
		    <article data-role="content">
                <h3>수정할 영화 검색</h3>
                <form name="form3-1" method="POST" action="delete.php" data-ajax="false">
                    <div class="ui-body ui-body-a">
                        <label>검색 영화명: </label>
                        <input type="search" name = "stitle" id="stitle valse="" data-mini="true" data-inline = "true">
                    </div>
