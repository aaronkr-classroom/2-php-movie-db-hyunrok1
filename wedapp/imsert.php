...
<html>
	<head><!--페이지정보 -->
		...
		<title>Movie wed app | Insert</title>
    </head>
	<body><!-- 페이지 내용 -->
		<!-- 영화 정보 추가 화면 -->
		 <main data-role = "page" id = "page0">
			<header data-role="header" data-position="fixed" data-theme="b">
                <a href="#page0" data-icon="back" data-rel="back">&larr; 뒤로(Back)</a>
				<h1>영화 정보 입력</h1>
		    ...
		    <article data-role="content">
                <form name ="form1" method = "POST" enctype = "multipart/form-data" action="insert_result.php" data-ajax="false">
                    ...
                    <div class = "ui-body ui - body - a">
                        <label>장로 : </label>
                        <select name="ganre" data-native-menu = "false" data-mini="true" data-inline="true" id="genre">
                        ...
                        <label>포스터 : </label>
                        <input type="file" name="text"id="text" data-mini="true data-inline="true">
                    </div>

                    <div class="ui-body">
                        <fieldset class="ui-grid-a">
                            <div class="ui-block-a">
                                <input type="submit" value="추가" data-mini="true">                            </div>
